...
## AI-Assisted Food Rescue Before the Night Is Over

Every evening, just before campus supermarkets, convenience stores, bakeries, and small cafes close, some food reaches a
quiet turning point.

It is not expired. Its package is still sealed. Its source is clear. But it may no longer look like tomorrow's freshest
stock, or the day's demand may have changed because of weather, exams, holidays, or closing time. Without a better way to
coordinate, that food can drift toward a discount shelf, a write-off record, or the trash.
...
The project is built on three practical commitments:

- **People decide:** AI assists with organizing information, drafting labels, suggesting routes, and generating reports. Final
  safety decisions must be made by trained people and partner organizations.
- **Safety beats volume:** We will not promise a fixed daily amount of redistributed food. We will only handle food that meets
  the pilot's intake rules.
- **Trust needs records:** Every accepted, distributed, or rejected batch should leave a visible record, so supporters can see
  both the results and the limits of the pilot.

We believe social innovation does not have to begin with a large platform or a heroic promise. It can begin with one campus, a
few responsible partners, and a process people can actually check.

## What Your Support Buys

We are raising funds to build and run the 30-day pilot. Your support will not be spent mainly on expensive software
development. It will be used for the ordinary tools and coordination costs that allow the pilot to operate carefully.

The funds will support:

- Label printer and label paper for clear source and time information.
- Insulated boxes or simple cooling containers for short-distance transport.
...
- **¥19 | Print the first label:** Help one batch of short-dated food receive proper registration, source information, and
  public recording.
- **¥49 | Cover one pickup:** Help cover short-distance transport and basic sorting materials.
- **¥99 | Pack the safety kit:** Fund gloves, sealing bags, alcohol wipes, thermometers, and label paper.
- **¥299 | Bring one store on board:** Support store onboarding, intake forms, label templates, and clear instruction signs.
- **¥999 | Set up the sorting corner:** Help provide a label printer, insulated box, sorting crates, and public display
  materials.
- **¥4999 | Carry the full 30 days:** Fund one complete campus or community trial and receive the final transparent pilot
  report.

By backing Tonight, Not Wasted, you are helping test whether a clearer, safer, and more transparent workflow can make local
food redistribution more practical.

## Thank You

Thank you for considering this project. Food waste is a large problem, and our pilot is only a small step. But small steps
matter when they are honest, testable, and open to improvement.

Every contribution helps us replace vague goodwill with a clearer process: better records, safer labels, trained volunteers,
and public reports. Whether you support one label, one pickup, one store, or the entire pilot, you help still-edible food
receive one more chance to be seen, recorded, and shared with dignity.

## Stay Involved

Tonight, Not Wasted depends on cooperation.

Stores can join as pilot partners and submit eligible short-dated food through a simple intake process. Volunteers can help
...
We do not want this project to feel like a one-way act of charity. We want it to become a visible community experiment in
which stores, volunteers, recipients, and supporters all understand how the process works.
...
Stores will submit eligible food information through the intake form. AI will organize the information, draft labels, and
suggest pickup priorities. Volunteers and partner staff will review the items, complete pickup, label accepted food, distribute
it at the designated point, and record the results.

**Week 4: Show what happened**

We will summarize the data, including partner participation, food categories, accepted and rejected items, volunteer
activities, fund use, and operational problems. We will publish a final pilot report and decide whether the model is suitable
for future improvement or replication.

The pilot has several planned goals:

- Connect 3-5 stores or food sources.
...
We will not promise a fixed amount of redistributed food, because food supply is uncertain. Instead, we promise to make the
process clear, cautious, and publicly reviewable.

## Risks We Will Not Hide

Food redistribution involves real uncertainty. The pilot will be useful only if it is honest about what it can and cannot do.
...
**Food supply:** Short-dated food cannot be guaranteed in fixed amounts. We will use same-day confirmation rather than claiming
precise prediction. Historical data will be used only to identify trends, improve volunteer scheduling, and reduce empty trips.

**AI assistance:** AI may misunderstand information or produce incomplete suggestions. For this reason, AI will never make
final safety decisions. It will only assist with information organization, prompts, route suggestions, label drafting, and
report generation. Human review remains essential.

**Student capacity:** We are not claiming to operate a complete food bank. This project is a pilot toolkit that should work
with schools, communities, stores, or charity organizations. If the pilot reveals problems, we will record them honestly
instead of treating them as failure.

Tonight, Not Wasted begins with a simple belief: waste is not always caused by lack of care. Sometimes it is caused by missing
information, unclear responsibility, and poor timing. With your support, we can test whether AI-assisted coordination can help
still-edible food reach nearby people before another ordinary night ends in waste.
